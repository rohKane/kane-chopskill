...
function endGame(outcome) {
    ...
    if (outcome === "win") {
        ...
        .then(data => {
            // Handle the data as needed (e.g., process the response)
            console.log(data);
        })
        .catch(() => {
        ...
        fetch(`https://${GetParentResourceName()}/GetResult`, {
            ...
            body: false, // Add your actual data here
        })
            .then(response => response.json())
            .then(data => {
                // Handle the data as needed (e.g., process the response)
...
//function applySettings() {
    ...
    //var timingSliderValue = "50";
    //var lettersSliderValue = "15";
...
//function resetSettings() {
    ...
    //timingSliderInput.value = "10";
    //lettersSliderInput.value = "15";
    //timingSliderValue.style.left = "10%";
    //lettersSliderValue.style.left = "0%";
    //timingSliderValue.textContent = "10";
